...
async function loadFacts() {
  const res = await fetch(
    "https://wtzibrvrggttathbhrqz.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind0emlicnZyZ2d0dGF0aGJocnF6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzUzOTA2MDksImV4cCI6MTk5MDk2NjYwOX0.YbgSVjgYzqof6_25Dt-bvKErgYgxE8Sl4Zs5sNdPXi8",
      },
    }
  );
...
const text = "Philly is the capital of Pennsylvania";
